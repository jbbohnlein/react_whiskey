...
function Navbar() {
  ...
  return (
    <nav className='flex items-center justify-between flex-wrap bg-yellow-800 p-6'>
        <div className='flex items-center flex-shrink-0 text-white mr-6 hover:text-black'>
            <Link to='/' className='font-semibold text-xl tracking-tight'>The Whiskey Shelf</Link>
        </div>
        <div className="block">
            <button 
                onClick={dropDown}
                className="flex items-center px-3 py-2 text-white 
                border rounded border-white hover:text-black hover:border-black"
                >
